...
# create a single-var vector of predictions from this data
...
pre2005.preds <- rep("Down", 252)
pre2005.preds[pre2005.fit.probs >0.5] <- "Up"
table(pre2005.preds, Direction.2005)
mean(pre2005.preds == Direction.2005)
```